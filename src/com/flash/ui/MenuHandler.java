...
public class MenuHandler {
    ...
    private void displayMainMenuOptions() {
        ...
        ConsoleUtil.printDivider();
        ConsoleUtil.printColored("请输入选择 (1-8): ", ConsoleUtil.MINT);
    }
    ...
    private void register() throws SQLException {
        ...
        ConsoleUtil.printColored("请输入用户名：", ConsoleUtil.SKY_BLUE);
        String username = scanner.nextLine();
        ConsoleUtil.printColored("请输入密码：", ConsoleUtil.SKY_BLUE);
    ...
    private void viewBooks() throws SQLException {
        while (true) {
            ...
            ConsoleUtil.printDivider();
            ConsoleUtil.printColored("请输入选择 (1-3): ", ConsoleUtil.MINT);
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    ConsoleUtil.printColored("请输入图书分类：", ConsoleUtil.SKY_BLUE);
    ...
    private void displayBooks(List<Book> books) {
        ...
        // 表头
        System.out.printf(ConsoleUtil.MINT + "%-4s | %-20s | %-15s | %-15s | %-10s | %-10s\n" + 
